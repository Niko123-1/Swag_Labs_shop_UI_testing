...
def test_item_displaying(item_details_page: ItemDetailsPage):
    item_details_page.check_item_name()
    item_details_page.check_item_desc()
    item_details_page.check_price_format()

def test_shopping_cart_interaction(item_details_page: ItemDetailsPage):
...
def test_add_item_to_cart(item_details_page: ItemDetailsPage):
    item_details_page.check_adding_item_to_cart()

def test_remove_item_from_cart(item_details_page: ItemDetailsPage):
    item_details_page.check_removing_item_from_cart()

def test_go_back_to_products(item_details_page: ItemDetailsPage):
    item_details_page.check_back_to_products_link()

def test_page_footer(item_details_page: ItemDetailsPage):
...
def test_check_burger_menu_interaction(item_details_page: ItemDetailsPage):
...
def test_burger_menu_menu_all_items_option(item_details_page: ItemDetailsPage):
    item_details_page.burger_menu.check_burger_menu_all_items_option()

def test_burger_menu_menu_about_option(item_details_page: ItemDetailsPage):
    item_details_page.burger_menu.check_burger_menu_about_option()

def test_burger_menu_menu_reset_app_state_option(item_details_page: ItemDetailsPage):
    item_details_page.burger_menu.check_burger_menu_reset_app_state_option()

def test_burger_menu_menu_logout_option(item_details_page: ItemDetailsPage):
