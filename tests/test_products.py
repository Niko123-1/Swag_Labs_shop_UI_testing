...
class TestProducts:
    ...
    def test_shopping_cart_interaction(self, products_page: ProductsPage):
    ...
    def test_products_page_title_displaying(self, products_page: ProductsPage):
        products_page.check_title_is_visible()

    def test_product_sort_dropdown_list_visible(self, products_page: ProductsPage):
    ...
    def test_product_sort_dropdown_list_interaction(self, products_page: ProductsPage, value: str):
        products_page.check_selection_of_value_from_products_sorting_dropdown_list(value)

    def test_page_footer(self, products_page: ProductsPage):
    ...
    def test_add_item_to_cart(self, products_page: ProductsPage):
        products_page.check_adding_item_to_cart()

    def test_remove_item_from_cart(self, products_page: ProductsPage):
        products_page.check_removing_item_from_cart()

    def test_burger_menu_menu_all_items_option(self, products_page: ProductsPage):
        products_page.burger_menu.check_burger_menu_all_items_option()

    def test_burger_menu_menu_about_option(self, products_page: ProductsPage):
        products_page.burger_menu.check_burger_menu_about_option()

    def test_burger_menu_menu_reset_app_state_option(self, products_page: ProductsPage):
        products_page.burger_menu.check_burger_menu_reset_app_state_option()

    def test_burger_menu_menu_logout_option(self, products_page: ProductsPage):
